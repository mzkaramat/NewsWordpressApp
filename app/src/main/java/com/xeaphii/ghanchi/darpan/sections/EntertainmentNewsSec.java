package com.xeaphii.ghanchi.darpan.sections;
...
import com.xeaphii.ghanchi.darpan.ViewPost;
import com.xeaphii.ghanchi.darpan.adapter.EntNewsAdapter;
import com.xeaphii.ghanchi.darpan.model.NewsItem;
...
public class EntertainmentNewsSec extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharedStorage = new StorageSharedPref(EntertainmentNewsSec.this);
        ...
        if(Adv !=null){
            ...
            AdvImage.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent i = new Intent(getApplicationContext(), com.xeaphii.ghanchi.darpan.AdvertisementNews.class);
                    startActivity(i);
                }
            });
        }
        ...
        Members.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if(Memberslist.get(position).isVisible.contains("0")){
                    Intent i = new Intent(EntertainmentNewsSec.this,DisplayUser.class);
        ...
        Members.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent i = new Intent(EntertainmentNewsSec.this,ViewPost.class);
                i.putExtra("post_id",Memberslist.get(position).id.toString());
                startActivity(i);
            }
        });
    }
    class uploadToServer extends AsyncTask<Void, Void, String> {
        ...
        private ProgressDialog pd = new ProgressDialog(EntertainmentNewsSec.this);
        ...
        protected String doInBackground(Void... params) {
            ...
            try {
                //------------------>>
                HttpGet httppost = new HttpGet(("http://www.ghanchidarpan.org/wp_site/wordpress/EntertainmentNews.php?offset=0"
                ) );
                ...
                String[] data = EntityUtils.toString(entity).trim().split(";",-1);
        ...
        protected void onPostExecute(String result) {
            ...
            pd.hide();
            pd.dismiss();
            adapter= new EntNewsAdapter(EntertainmentNewsSec.this, Memberslist);
