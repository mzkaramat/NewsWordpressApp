...
import com.xeaphii.ghanchi.darpan.adapter.CommNewsAdapter;
...
public class CommunityNew extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Members.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if(Memberslist.get(position).isVisible.contains("0")){
                    Intent i = new Intent(CommunityNew.this,DisplayUser.class);
        ...
        Members.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent i = new Intent(CommunityNew.this,ViewPost.class);
    ...
    class uploadToServer extends AsyncTask<Void, Void, String> {
        ...
        private ProgressDialog pd = new ProgressDialog(CommunityNew.this);
        ...
        protected String doInBackground(Void... params) {
            ...
            try {
                //------------------>>
                HttpGet httppost = new HttpGet(("http://www.ghanchidarpan.org/wp_site/wordpress/communityNews.php?offset=0"
                ) );
