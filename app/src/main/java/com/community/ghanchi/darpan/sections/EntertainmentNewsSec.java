...
import com.community.ghanchi.darpan.ViewPost;
import com.community.ghanchi.darpan.adapter.EntNewsAdapter;
import com.community.ghanchi.darpan.model.NewsItem;
        ...
        if(Adv !=null){
            ...
            AdvImage.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent i = new Intent(getApplicationContext(), com.community.ghanchi.darpan.AdvertisementNews.class);
                    startActivity(i);
                }
            });
        }
