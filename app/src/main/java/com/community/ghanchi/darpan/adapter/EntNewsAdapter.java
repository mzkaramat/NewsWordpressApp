package com.community.ghanchi.darpan.adapter;
 ...
 */
public class EntNewsAdapter  extends ArrayAdapter<NewsItem> {
    ...
    public EntNewsAdapter(Context context, List<NewsItem>  values) {
...
//        }
    ...
    class uploadToServer extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                //------------------>>
                HttpGet httppost = new HttpGet(("http://ghanchidarpan.org/wp_site/wordpress/EntertainmentNews.php?offset=" +
                        params[0]
                ).replaceAll(" ", "%20") );
